...
const metadata = {
    ru: {
      ...
      openGraph: {
        title: 'BEST — Производство качественной водки',
        url: 'https://best-spirits.com/ru/produksiya',
    ...
    az: {
      ...
      openGraph: {
        title: 'BEST — Keyfiyyətli arağ istehsalı',
        url: 'https://best-spirits.com//az/məhsullar',
        siteName: 'Best Spirits',
        images: [
          {
            url: '/assets/img/logo.svg',
    ...
    en: {
      ...
      openGraph: {
        title: 'BEST — Premium Vodka Production',
        url: 'https://best-spirits.com/en/products',
        siteName: 'Best Spirits',
        images: [
          {
            url: '/assets/img/logo.svg',
