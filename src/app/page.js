      ...
      <section className={s.new__prod}>
        <div className='container'>
          <div className={s.prod__info}>
            <h2>Водка "GREEN GARDEN"</h2>
            <p>Водка 'GREEN GARDEN' — это чистый, мягкий вкус, созданный из натуральных ингредиентов, дарованных северной природой. Сочетание кристально чистой воды и отборных злаков придает напитку характерную свежесть и легкость.</p>
          </div>
