      ...
      <div className="col-lg-12 col-md-12 col-sm-12 col-12 pb-3 mb-4 d-flex justify-content-center align-items-center">
        <div className="shorts_page_card">
          <div className={`wrapper ${openComment ? "comment-open" : ""}`}>
            <div ref={videoPlayer} className={`main ${openComment ? "comment-open" : ""}`} onClick={() => {
            ...
            isPlaying = !isPlaying
              ...
              <ReactPlayer
                ...
                onStart = {() => {
                  videoPlayer.current.querySelector('video').muted = false;
                  videoPlayer.current.querySelector('video').play = true
                }}
